...
public class CasaHomeEstudianteFragment extends Fragment implements Response.Listener<JSONObject>,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("Hola!!! " + nameestudiante);
        ...
        btn_gam_play=view.findViewById(R.id.btn_gam_play);
        btn_gam_play.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                rv_misDeberes.setVisibility(View.VISIBLE);
                btn_gam_play.setVisibility(View.GONE);
            }
        });
