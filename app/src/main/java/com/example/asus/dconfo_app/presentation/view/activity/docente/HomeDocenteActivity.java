...
public class HomeDocenteActivity extends AppCompatActivity
    ...
    //gamificación
    Button btn_gam_asignar;
    Button btn_gam_ejercicios;
    Button btn_gam_grupos;
...
//        Bundle datos = intent.getIntent().getBundleExtra("idgrupo");
        ...
        //*******************************************************************GAMIFICACIÓN
        btn_gam_asignar=findViewById(R.id.btn_gam_asignar);
        btn_gam_asignar.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btn_gam_ejercicios=findViewById(R.id.btn_gam_ejercicios);
        btn_gam_ejercicios.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Bundle args = new Bundle();
                args.putInt("iddocente", iddocente);
        ...
        btn_gam_grupos=findViewById(R.id.btn_gam_grupos);
        btn_gam_grupos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Bundle args = new Bundle();
                args.putInt("iddocente", iddocente);
       ...
       /* btnInicio = (Button) findViewById(R.id.btn_docente_content);
        ...
        rv_docente_conciencias.setVisibility(View.GONE);
